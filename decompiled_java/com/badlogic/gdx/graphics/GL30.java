...
public abstract interface GL30 extends GL20 {
    ...
    public abstract void glBeginTransformFeedback(int arg0);

    public abstract void glBindBufferBase(int arg0, int arg1, int arg2);

    public abstract void glBindBufferRange(int arg0, int arg1, int arg2, int arg3, int arg4);

    public abstract void glBindSampler(int arg0, int arg1);

    public abstract void glBindTransformFeedback(int arg0, int arg1);

    public abstract void glBindVertexArray(int arg0);

    public abstract void glBlitFramebuffer(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9);

    public abstract void glClearBufferfi(int arg0, int arg1, float arg2, int arg3);

    public abstract void glClearBufferfv(int arg0, int arg1, FloatBuffer arg2);

    public abstract void glClearBufferiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glClearBufferuiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glCopyBufferSubData(int arg0, int arg1, int arg2, int arg3, int arg4);
    ...
    public abstract void glDeleteQueries(int arg0, IntBuffer arg1);

    public abstract void glDeleteQueries(int arg0, int[] arg1, int arg2);

    public abstract void glDeleteSamplers(int arg0, IntBuffer arg1);

    public abstract void glDeleteSamplers(int arg0, int[] arg1, int arg2);

    public abstract void glDeleteTransformFeedbacks(int arg0, IntBuffer arg1);

    public abstract void glDeleteTransformFeedbacks(int arg0, int[] arg1, int arg2);

    public abstract void glDeleteVertexArrays(int arg0, IntBuffer arg1);

    public abstract void glDeleteVertexArrays(int arg0, int[] arg1, int arg2);

    public abstract void glDrawArraysInstanced(int arg0, int arg1, int arg2, int arg3);

    public abstract void glDrawBuffers(int arg0, IntBuffer arg1);

    public abstract void glDrawElementsInstanced(int arg0, int arg1, int arg2, int arg3, int arg4);

    public abstract void glDrawRangeElements(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5);

    public abstract void glDrawRangeElements(int arg0, int arg1, int arg2, int arg3, int arg4, Buffer arg5);

    public abstract void glEndQuery(int arg0);

    public abstract void glEndTransformFeedback();

    public abstract void glFlushMappedBufferRange(int arg0, int arg1, int arg2);

    public abstract void glFramebufferTextureLayer(int arg0, int arg1, int arg2, int arg3, int arg4);

    public abstract void glGenQueries(int arg0, IntBuffer arg1);

    public abstract void glGenQueries(int arg0, int[] arg1, int arg2);

    public abstract void glGenSamplers(int arg0, IntBuffer arg1);

    public abstract void glGenSamplers(int arg0, int[] arg1, int arg2);

    public abstract void glGenTransformFeedbacks(int arg0, IntBuffer arg1);

    public abstract void glGenTransformFeedbacks(int arg0, int[] arg1, int arg2);

    public abstract void glGenVertexArrays(int arg0, IntBuffer arg1);

    public abstract void glGenVertexArrays(int arg0, int[] arg1, int arg2);

    public abstract String glGetActiveUniformBlockName(int arg0, int arg1);

    public abstract void glGetActiveUniformBlockName(int arg0, int arg1, Buffer arg2, Buffer arg3);

    public abstract void glGetActiveUniformBlockiv(int arg0, int arg1, int arg2, IntBuffer arg3);

    public abstract void glGetActiveUniformsiv(int arg0, int arg1, IntBuffer arg2, int arg3, IntBuffer arg4);

    public abstract void glGetBufferParameteri64v(int arg0, int arg1, LongBuffer arg2);

    public abstract Buffer glGetBufferPointerv(int arg0, int arg1);

    public abstract int glGetFragDataLocation(int arg0, String arg1);

    public abstract void glGetInteger64v(int arg0, LongBuffer arg1);

    public abstract void glGetQueryObjectuiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glGetQueryiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glGetSamplerParameterfv(int arg0, int arg1, FloatBuffer arg2);

    public abstract void glGetSamplerParameteriv(int arg0, int arg1, IntBuffer arg2);

    public abstract String glGetStringi(int arg0, int arg1);

    public abstract int glGetUniformBlockIndex(int arg0, String arg1);

    public abstract void glGetUniformIndices(int arg0, String[] arg1, IntBuffer arg2);

    public abstract void glGetUniformuiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glGetVertexAttribIiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glGetVertexAttribIuiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glInvalidateFramebuffer(int arg0, int arg1, IntBuffer arg2);

    public abstract void glInvalidateSubFramebuffer(int arg0, int arg1, IntBuffer arg2, int arg3, int arg4, int arg5, int arg6);

    public abstract boolean glIsQuery(int arg0);

    public abstract boolean glIsSampler(int arg0);

    public abstract boolean glIsTransformFeedback(int arg0);

    public abstract boolean glIsVertexArray(int arg0);

    public abstract void glPauseTransformFeedback();

    public abstract void glProgramParameteri(int arg0, int arg1, int arg2);

    public abstract void glReadBuffer(int arg0);

    public abstract void glRenderbufferStorageMultisample(int arg0, int arg1, int arg2, int arg3, int arg4);

    public abstract void glResumeTransformFeedback();

    public abstract void glSamplerParameterf(int arg0, int arg1, float arg2);

    public abstract void glSamplerParameterfv(int arg0, int arg1, FloatBuffer arg2);

    public abstract void glSamplerParameteri(int arg0, int arg1, int arg2);

    public abstract void glSamplerParameteriv(int arg0, int arg1, IntBuffer arg2);
    ...
    public abstract void glTransformFeedbackVaryings(int arg0, String[] arg1, int arg2);

    public abstract void glUniform1uiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glUniform3uiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glUniform4uiv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glUniformBlockBinding(int arg0, int arg1, int arg2);

    public abstract void glUniformMatrix2x3fv(int arg0, int arg1, boolean arg2, FloatBuffer arg3);

    public abstract void glUniformMatrix2x4fv(int arg0, int arg1, boolean arg2, FloatBuffer arg3);

    public abstract void glUniformMatrix3x2fv(int arg0, int arg1, boolean arg2, FloatBuffer arg3);

    public abstract void glUniformMatrix3x4fv(int arg0, int arg1, boolean arg2, FloatBuffer arg3);

    public abstract void glUniformMatrix4x2fv(int arg0, int arg1, boolean arg2, FloatBuffer arg3);

    public abstract void glUniformMatrix4x3fv(int arg0, int arg1, boolean arg2, FloatBuffer arg3);

    public abstract boolean glUnmapBuffer(int arg0);

    public abstract void glVertexAttribDivisor(int arg0, int arg1);

    public abstract void glVertexAttribI4i(int arg0, int arg1, int arg2, int arg3, int arg4);

    public abstract void glVertexAttribI4ui(int arg0, int arg1, int arg2, int arg3, int arg4);

    public abstract void glVertexAttribIPointer(int arg0, int arg1, int arg2, int arg3, int arg4);

    public abstract void glVertexAttribPointer(int arg0, int arg1, int arg2, boolean arg3, int arg4, Buffer arg5);
}
