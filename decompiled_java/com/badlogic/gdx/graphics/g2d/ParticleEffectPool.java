...
public class ParticleEffectPool extends Pool {
    public class PooledEffect extends ParticleEffect {
        PooledEffect(ParticleEffectPool arg1, ParticleEffect effect) {
            ParticleEffectPool.this = arg1;
            super(effect);
        }
    ...
    protected PooledEffect newObject() {
        return new PooledEffect(this, this.effect);
    }
    ...
    public PooledEffect obtain() {
        ...
        ((PooledEffect)v0).reset();
        return ((PooledEffect)v0);
    }
