...
public abstract interface TextureProvider {
    ...
    public class FileTextureProvider implements TextureProvider {
        ...
        public Texture load(String fileName) {
            Texture v0 = new Texture(Gdx.files.internal(fileName));
            v0.setFilter(TextureFilter.Linear, TextureFilter.Linear);
            v0.setWrap(TextureWrap.Repeat, TextureWrap.Repeat);
            return v0;
        }
    }

    public abstract Texture load(String arg0);
}
