...
public class ScaleInfluencer extends SimpleInfluencer {
    ...
    public ScaleInfluencer(ScaleInfluencer scaleInfluencer) {
        super(((SimpleInfluencer)scaleInfluencer));
    }
    ...
    public void activateParticles(int startIndex, int count) {
        ...
        if(this.value.isRelative()) {
            ...
            while(v3 < v1) {
                v4 = this.value.newLowValue() * this.controller.scale.x;
                v2 = this.value.newHighValue() * this.controller.scale.x;
            ...
            while(v3 < v1) {
                v4 = this.value.newLowValue() * this.controller.scale.x;
                v2 = this.value.newHighValue() * this.controller.scale.x - v4;
                this.interpolationChannel.data[v0] = v4;
                this.interpolationChannel.data[v0 + 1] = v2;
                this.valueChannel.data[v3] = this.value.getScale(0f) * v2 + v4;
                v3 += this.valueChannel.strideSize;
