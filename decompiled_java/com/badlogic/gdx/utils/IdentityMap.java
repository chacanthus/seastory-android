...
public class IdentityMap implements Iterable {
    public class Entries extends MapIterator {
        ...
        public Entries(IdentityMap arg2) {
            super(arg2);
    ...
    abstract class MapIterator implements Iterable, Iterator {
        ...
        public MapIterator(IdentityMap arg2) {
            super();
            this.valid = true;
            this.map = arg2;
            this.reset();
    ...
    public class Values extends MapIterator {
        public Values(IdentityMap arg1) {
            super(arg1);
        }
        ...
        public void toArray(Array arg2) {
            while(this.hasNext) {
                arg2.add(this.next());
            }
        }
    ...
    public boolean containsKey(Object arg4) {
        boolean v2;
        int v0 = System.identityHashCode(arg4);
        if(arg4 == this.keyTable[v0 & this.mask] || arg4 == this.keyTable[this.hash2(v0)] || arg4 == this.keyTable[this.hash3(v0)]) {
            v2 = true;
        }
        else {
    ...
    public Object get(Object arg4) {
        ...
        int v0 = System.identityHashCode(arg4);
        int v1 = v0 & this.mask;
        if(arg4 != this.keyTable[v1]) {
            v1 = this.hash2(v0);
            if(arg4 != this.keyTable[v1]) {
                v1 = this.hash3(v0);
                if(arg4 != this.keyTable[v1]) {
                    v2 = this.getStash(arg4, null);
                }
                else {
                    goto label_17;
                }
    ...
    label_5:
        ...
        int v2 = System.identityHashCode(v0);
        index1 = v2 & v5;
        arg14 = v4[index1];
        if(arg14 == null) {
            v4[index1] = v0;
    ...
    public Object put(Object arg15, Object arg16) {
        int v0;
        Object v13;
        if(arg15 == null) {
        ...
        int v9 = System.identityHashCode(arg15);
        int v3 = v9 & this.mask;
        Object v4 = v11[v3];
        if(v4 == arg15) {
    ...
    private void putResize(Object arg11, Object arg12) {
        int v0;
        int v9 = System.identityHashCode(arg11);
        int v3 = v9 & this.mask;
    ...
    public Object remove(Object arg6) {
        Object v2;
        Object v4 = null;
        int v0 = System.identityHashCode(arg6);
        int v1 = v0 & this.mask;
        if(this.keyTable[v1] == arg6) {
            this.keyTable[v1] = v4;
            v2 = this.valueTable[v1];
