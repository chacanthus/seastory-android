...
public class ObjectFloatMap implements Iterable {
    public class Entries extends MapIterator implements Iterable, Iterator {
        ...
        public Entries(ObjectFloatMap arg2) {
            super(arg2);
    ...
    public class Keys extends MapIterator implements Iterable, Iterator {
        public Keys(ObjectFloatMap arg1) {
            super(arg1);
        }
    ...
    class MapIterator {
        ...
        public MapIterator(ObjectFloatMap arg2) {
            super();
            this.valid = true;
            this.map = arg2;
            this.reset();
    ...
    public class Values extends MapIterator {
        public Values(ObjectFloatMap arg1) {
            super(arg1);
        }
        ...
        public float next() {
            ...
            float v0 = this.map.valueTable[this.nextIndex];
            this.currentIndex = this.nextIndex;
            this.findNextIndex();
            return v0;
        }
        ...
        public FloatArray toArray() {
            FloatArray v0 = new FloatArray(true, this.map.size);
            while(this.hasNext) {
                v0.add(this.next());
            }
    ...
    public ObjectFloatMap(ObjectFloatMap arg5) {
    ...
    public float get(Object arg4, float defaultValue) {
        float v2;
        int v0 = arg4.hashCode();
        int v1 = v0 & this.mask;
    ...
    public float getAndIncrement(Object arg6, float defaultValue, float increment) {
        float v2;
    ...
    private float getAndIncrementStash(Object arg7, float defaultValue, float increment) {
        float v3;
        Object[] v1 = this.keyTable;
        int v0 = this.capacity;
        int v2 = v0 + this.stashSize;
    ...
    private float getStash(Object arg5, float defaultValue) {
        Object[] v1 = this.keyTable;
        int v0 = this.capacity;
        int v2 = v0 + this.stashSize;
        while(v0 < v2) {
    ...
    private void push(Object arg11, float insertValue, int index1, Object arg14, int index2, Object arg16, int index3, Object arg18) {
        int v8;
        float v1;
        Object v0;
        Object[] v4 = this.keyTable;
        float[] v7 = this.valueTable;
        int v5 = this.mask;
        int v3 = 0;
    ...
    public void put(Object arg14, float value) {
        int v0;
        if(arg14 == null) {
    ...
    public void putAll(ObjectFloatMap arg5) {
    ...
    private void putResize(Object arg11, float value) {
        int v0;
    ...
    private void putStash(Object arg4, float value) {
    ...
    public float remove(Object arg6, float defaultValue) {
        float v2;
        Object v4 = null;
        int v0 = arg6.hashCode();
        int v1 = v0 & this.mask;
    ...
    float removeStash(Object arg6, float defaultValue) {
        float v3;
        Object[] v1 = this.keyTable;
        int v0 = this.capacity;
        int v2 = v0 + this.stashSize;
