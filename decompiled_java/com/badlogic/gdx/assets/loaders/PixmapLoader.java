...
public class PixmapLoader extends AsynchronousAssetLoader {
    public class PixmapParameter extends AssetLoaderParameters {
    ...
    public Array getDependencies(String x0, FileHandle x1, AssetLoaderParameters x2) {
        return this.getDependencies(x0, x1, ((PixmapParameter)x2));
    }

    public Array getDependencies(String fileName, FileHandle file, PixmapParameter parameter) {
        return null;
    }

    public void loadAsync(AssetManager x0, String x1, FileHandle x2, AssetLoaderParameters x3) {
        this.loadAsync(x0, x1, x2, ((PixmapParameter)x3));
    }
    ...
    public Object loadSync(AssetManager x0, String x1, FileHandle x2, AssetLoaderParameters x3) {
        return this.loadSync(x0, x1, x2, ((PixmapParameter)x3));
    }
}
