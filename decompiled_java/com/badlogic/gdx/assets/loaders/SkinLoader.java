...
public class SkinLoader extends AsynchronousAssetLoader {
    public class SkinParameter extends AssetLoaderParameters {
        ...
        public SkinParameter(String textureAtlasPath, ObjectMap arg2) {
            super();
    ...
    public Skin loadSync(AssetManager manager, String fileName, FileHandle file, SkinParameter parameter) {
        ...
        String v5;
        if(parameter == null) {
            v5 = file.pathWithoutExtension() + ".atlas";
            v3 = null;
        }
        else {
            v5 = parameter.textureAtlasPath;
            v3 = parameter.resources;
        }

        Skin v4 = new Skin(manager.get(v5, TextureAtlas.class));
        if(v3 != null) {
            Iterator v2 = v3.entries().iterator();
            while(v2.hasNext()) {
                Object v1 = v2.next();
                v4.add(((Entry)v1).key, ((Entry)v1).value);
            }
        }
