...
public class GLSurfaceView20API18 extends GLSurfaceViewAPI18 {
    class ConfigChooser implements GLSurfaceView$EGLConfigChooser {
        ...
        private void printConfig(EGL10 egl, EGLDisplay display, EGLConfig config) {
            ...
            for(v2 = 0; v2 < v1.length; ++v2) {
                ...
                if(egl.eglGetConfigAttrib(display, config, v0, v5)) {
                    String v6 = GLSurfaceView20API18.TAG;
        ...
        private void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            ...
            String v2 = GLSurfaceView20API18.TAG;
            Log.w(v2, String.format("%d configurations", Integer.valueOf(v1)));
            int v0;
            for(v0 = 0; v0 < v1; ++v0) {
                v2 = GLSurfaceView20API18.TAG;
                v4 = new Object[1];
    ...
    static  {
        GLSurfaceView20API18.TAG = "GL2JNIView";
    }
    ...
    static void checkEglError(String prompt, EGL10 egl) {
        while(true) {
            ...
            String v1 = GLSurfaceView20API18.TAG;
