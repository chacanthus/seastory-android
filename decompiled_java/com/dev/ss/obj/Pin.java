...
public class Pin extends Ani {
    public float half_height;
    public float half_width;

    public Pin(int _iPartCnt, float _frameDuration, int _iTotalFrameCount) {
    ...
    public void draw(float _deltaTime) {
        ...
        GameScreen.batch.draw(Res.rgPin[this.getPartFrameNumber()], this.x, this.y, this.width, this.height);
    }
}
